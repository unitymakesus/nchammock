...
class BeRocket_AAPF_single_filter extends BeRocket_custom_post_class {
    ...
    public function setup_widget($post) {
        ...
        echo '<a href="'.plugins_url( 'images/adding-widgets.gif', BeRocket_AJAX_filters_file ).'"><img style="max-width:100%;" src="'.plugins_url( 'images/adding-widgets.gif', BeRocket_AJAX_filters_file ).'"></a>';
    }
