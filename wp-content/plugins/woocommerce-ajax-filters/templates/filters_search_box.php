<div>
    <label>
        <input class="berocket_admin_search_box_enable" type="checkbox" name="br_filter_group[search_box]" value="1"<?php echo (empty($filters['search_box']) ? '' : ' checked') ?>>
...
<div class="berocket_aapf_admin_search_box"<?php if( empty($filters['search_box']) ) echo ' style="display: none;"'; ?>>
    <div>
        ...
        <select name="br_filter_group[search_box_link_type]" class="berocket_search_link_select br_select_menu_left">
    ...
    <div class="berocket_search_link berocket_search_link_category"<?php if( $filters['search_box_link_type'] != 'category' ) echo ' style="display:none;"'; ?>>
        ...
        <select class="br_select_menu_left" name="br_filter_group[search_box_category]">
        <?php 
    ...
    <div class="berocket_search_link berocket_search_link_url"<?php if( $filters['search_box_link_type'] != 'url' ) echo ' style="display:none;"'; ?>>
        ...
        <input class="br_admin_full_size" id="search_box_url" name="br_filter_group[search_box_url]" type="text" value="<?php echo $filters['search_box_url']; ?>">
    </div>
    <div class="br_accordion">
        ...
        <div>
            <div>
                ...
                <select class="br_select_menu_left" name="br_filter_group[search_box_style][position]">
            ...
            <div>
                ...
                <select class="br_select_menu_left" name="br_filter_group[search_box_style][search_position]">
            ...
            <div>
                ...
                <input type="text" class="br_admin_full_size" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'search_text')); ?>" name="br_filter_group[search_box_style][search_text]">
            </div>
            <div>
                ...
                <input type="hidden" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'background')) ?>" name="br_filter_group[search_box_style][background]">
            </div>
            <div>
                <label><?php _e('Background transparency', 'BeRocket_AJAX_domain') ?></label>
                <select class="br_select_menu_left" name="br_filter_group[search_box_style][back_opacity]">
                    <?php
                    $back_opacity = array(
            ...
            <div>
                ...
                <input type="hidden" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'button_background')) ?>" name="br_filter_group[search_box_style][button_background]">
            </div>
            <div>
                ...
                <input type="hidden" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'button_background_over')) ?>" name="br_filter_group[search_box_style][button_background_over]">
            </div>
            <div>
                ...
                <input type="hidden" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'text_color')) ?>" name="br_filter_group[search_box_style][text_color]">
            </div>
            <div>
                ...
                <input type="hidden" value="<?php echo br_get_value_from_array($filters, array('search_box_style', 'text_color_over')) ?>" name="br_filter_group[search_box_style][text_color_over]">
            </div>
        </div>
    </div>
</div>
